...
export default function AppPage() {
    ...
    const showToast = (msg) => shopify.toast.show(msg);
    ...
    const {
        ...
        handleDeleteFont,
        handleApplyFont,
    } = useFontData({ setToastContent: showToast, setToastActive: () => { }, setErrorContent, setErrorActive });
    ...
    useEffect(() => {
        ...
        if (location.state.toastMessage || location.state.deleteMessage) {
            shopify.toast.show(location.state.toastMessage || location.state.deleteMessage);
                            ...
                            {fontData.length === 0 ? (
                                ...
                                <Card>
                                    <BlockStack style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', margin: '0px 8px' }}>
                                        <Text variant="headingMd" as="h6">Add fonts</Text>
                                        <Button url="/fonts" variant="primary">Add new font</Button>
                                    </BlockStack>
                                    <BlockStack>
                                        {filterControl}
                                        <ResourceList
